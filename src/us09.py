...
+		if (dif_time > 9):
+			print("Error US09: Birthdate of child " + childsname + " (" + childsid + ") is >9 months after father's death .")
+	
+	elif (rs_stories.form_d(parentsdeaf, childsbirthday) == 2):
+		print("Error US09: Birthdate of child " + childsname + " (" + childsid + ") is after mother's death.")
